...
def test_no_display_issues_when_three_or_more_prs_not_llm_working(
    ...
    # With 3 or more PRs not all in "LLM working", issues should not be displayed
    assert not mock_display_issues.called, "Issues should NOT be displayed when PR count is 3+ and not all LLM working"
