...
import src.gh_pr_phase_monitor.browser.browser_automation as browser_automation
import src.gh_pr_phase_monitor.browser.browser_cooldown as browser_cooldown
...
class TestProcessDetection:
    ...
    def test_is_process_running_returns_true_when_process_exists(self, mocker):
    ...
    def test_is_process_running_returns_false_when_process_not_exists(self, mocker):
    ...
    def test_is_process_running_handles_subprocess_error(self, mocker):
    ...
    def test_is_process_running_handles_file_not_found_error(self, mocker):
    ...
    def test_is_process_running_handles_nonzero_return_code(self, mocker):
    ...
    def test_is_process_running_fallback_to_ps_when_pgrep_unavailable(self, mocker):
...
class TestAutoraiseBehavior:
    ...
    def test_should_autoraise_returns_true_when_config_disabled(self, mocker):
    ...
    def test_should_autoraise_returns_false_when_process_running_and_config_enabled(self, mocker):
...
class TestBrowserAutomationIntegration:
    ...
    def test_assign_issue_uses_autoraise_false_when_process_running(self, mocker):
    ...
    def test_merge_pr_uses_autoraise_false_when_process_running(self, mocker):
        ...
        from src.gh_pr_phase_monitor.browser.browser_automation import merge_pr_automated
...
class TestOpenBrowserIntegration:
    ...
    def test_open_browser_uses_autoraise_false_when_process_running(self, mocker):
        ...
        mock_is_running = mocker.patch("src.gh_pr_phase_monitor.browser.browser_automation.is_process_running")
        mock_webbrowser = mocker.patch("src.gh_pr_phase_monitor.actions.pr_actions.webbrowser")
