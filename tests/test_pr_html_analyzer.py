"""
Tests for pr_html_analyzer module (core: draft detection, status determination, save JSON).

Copilot review-specific tests (no-inline-comments detection, reviewed extraction) are in
