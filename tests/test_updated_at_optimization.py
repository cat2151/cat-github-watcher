...
class TestGetReposChangedSinceLastCheck:
    ...
    def test_stores_baseline_on_first_call(self):
    ...
    def test_returns_empty_set_when_nothing_changed(self):
    ...
    def test_returns_changed_repo_names(self):
    ...
    def test_returns_multiple_changed_repo_names(self):
    ...
    def test_includes_new_repos_not_in_baseline(self):
    ...
    def test_updates_baseline_after_second_call(self):
