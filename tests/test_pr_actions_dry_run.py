...
class TestDryRunMode:
    ...
    def test_phase1_dry_run_by_default(self, mocker):
    ...
    def test_phase1_executes_when_enabled(self, mocker):
    ...
    def test_phase2_dry_run_by_default(self, mocker):
    ...
    def test_phase2_executes_when_enabled(self, mocker):
    ...
    def test_phase3_dry_run_ntfy_by_default(self, mocker):
    ...
    def test_phase3_executes_ntfy_when_enabled(self, mocker):
    ...
    def test_phase3_notification_can_be_sent_after_dry_run(self, mocker):
