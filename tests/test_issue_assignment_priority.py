...
def test_assign_only_fetches_from_enabled_repos(mocker):
    """
...
def test_priority_prefers_ci_failure_then_deploy_then_good_first(mocker):
    """
...
def test_fallback_to_deploy_pages_failure_when_no_ci_failure(mocker):
    """
