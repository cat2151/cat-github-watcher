...
class TestClickButtonWithImage:
    ...
    def test_returns_false_when_screenshot_not_found(self, mocker):
    ...
    def test_returns_false_when_button_not_on_screen(self, mocker):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_skips_search_when_user_cancelled(self, mocker, monkeypatch):
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_retries_after_maximize_when_not_found_first(self, mocker):
        mock_sleep = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.time.sleep")
        mock_maximize = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._maybe_maximize_window")
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_skip_maximize_when_config_disabled(self, mocker):
        mock_sleep = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.time.sleep")
        mock_maximize = mocker.patch("src.gh_pr_phase_monitor.browser.window_manager._maximize_window")
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
        ...
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._click_button_with_ocr", return_value=False)
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._save_debug_info")
    ...
    def test_clicks_button_when_found(self, mocker):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_polls_until_max_attempts_with_interval(self, mocker):
        mock_sleep = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.time.sleep")
        mock_maximize = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._maybe_maximize_window", return_value=False)
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_reverifies_before_click_with_pre_click_delay(self, mocker):
        mock_sleep = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.time.sleep")
        mock_maximize = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._maybe_maximize_window", return_value=False)
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
        ...
        mock_pyautogui = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.pyautogui")
        first_location = mocker.MagicMock(name="first")
        second_location = mocker.MagicMock(name="second")
    ...
    def test_reverifies_before_click_no_delay_when_zero(self, mocker):
        mock_sleep = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.time.sleep")
        mock_maximize = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._maybe_maximize_window", return_value=False)
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
...
class TestSaveDebugInfo:
    ...
    def test_saves_debug_screenshot_on_failure(self, mocker, tmp_path):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_saves_debug_json_on_failure(self, mocker, tmp_path):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_creates_debug_dir_if_not_exists(self, mocker, tmp_path):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_does_nothing_when_pyautogui_unavailable(self, mocker, tmp_path):
    ...
    def test_uses_default_debug_dir(self, mocker, tmp_path, monkeypatch):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_click_button_calls_save_debug_info_on_failure(self, mocker, tmp_path):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
    ...
    def test_click_button_saves_debug_info_on_exception(self, mocker, tmp_path):
        mock_get_path = mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker._get_screenshot_path")
        mocker.patch("src.gh_pr_phase_monitor.browser.button_clicker.PYAUTOGUI_AVAILABLE", True)
