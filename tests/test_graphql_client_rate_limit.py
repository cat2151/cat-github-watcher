...
def test_execute_graphql_query_raises_rate_limit_error_on_api_limit_exceeded(mocker):
...
def test_execute_graphql_query_keeps_non_rate_limit_errors_as_runtime_error(mocker):
    mock_run = mocker.patch("subprocess.run")
